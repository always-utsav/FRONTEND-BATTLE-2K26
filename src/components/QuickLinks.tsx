...
export default function QuickLinks() {
  const links = [
    { title: "Syllabus", desc: "View all latest academic schemes", icon: FileText, color: "text-blue-600", bg: "bg-blue-50/50", href: "/scheme" },
    { title: "Exam Timetable", desc: "Mid Sem and End Sem schedules", icon: Calendar, color: "text-cyan-600", bg: "bg-cyan-50/50", href: "#" },
    { title: "Results", desc: "Semester wise result portal", icon: Trophy, color: "text-emerald-600", bg: "bg-emerald-50/50", href: "#" },
    { title: "Forms", desc: "Challan and required documents", icon: ClipboardList, color: "text-indigo-600", bg: "bg-indigo-50/50", href: "#" }
  ];
      ...
      {links.map((link, idx) => (
        <Link key={link.title} href={link.href}>
          <motion.div
            ...
            className="group cursor-pointer bg-white/70 backdrop-blur-xl border border-white/50 p-6 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] hover:shadow-[0_20px_40px_rgb(0,0,0,0.12)] hover:-translate-y-2 transition-all duration-300 relative overflow-hidden h-full"
          >
